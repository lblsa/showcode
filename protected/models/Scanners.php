...
class Scanners extends CActiveRecord
{
	...
	public function getTextEmailOnDevice($messenge){
            ...
            $text .= '<tr>';
            $text .= '<td colspan="2"><img src="https://' .$_SERVER['HTTP_HOST']. '/images/email/logo_empty.jpg" alt="Showcode" title="Showcode" style="margin: 0pt; padding: 0pt; border: 0pt none; display: block;"></td>';
	    $text .= '</tr>';
	    $text .= '<tr>';
