	...
	*/
	...
	public function getHtmlCode()
	{
		...
		$HtmlCode.= '<a style="background: url(https://' .$_SERVER['HTTP_HOST']. '/images/button_buy_ticket.png) no-repeat scroll left top transparent; color: #FFFFFF; cursor: pointer; display: block; font-size: 13px; height: 41px; line-height: 20px; margin: 4px auto; padding-bottom: 2px; position: relative; text-align: center; text-decoration: none; text-shadow: 0 1px 1px #565656; vertical-align: middle; width: 180px;" id="button_bye" href="#" onClick="openMenu();return false;"></a>';
                ...
                $HtmlCode.= '<input type="button" value="" onclick="javascript:closeMenu();return false;" id="buy_close" style="width: 17px;border: none; background:url(https://' .$_SERVER['HTTP_HOST']. '/images/close_button.png) left top no-repeat; display: block; left: 740px; top: 20px; position: absolute; cursor: pointer;" />';
                $HtmlCode.= '<iframe src="https://' .$_SERVER['HTTP_HOST']. '/events/iframe/' .$this->id. '" width="100%" height="100%" style="border:none;"></iframe>';
                $HtmlCode.= '</div>';
		return $HtmlCode;
	}
