...
class Contacts extends CActiveRecord
{
	...
	*/
	...
	public function getTextEmailOfFeedback(){
            ...
            $text .= '<tr>';
            $text .= '<td colspan="2"><img src="/images/email/logo_feedback.jpg" alt="Showcode. Обратная связь." title="Showcode. Обратная связь." style="margin: 0pt; padding: 0pt; border: 0pt none; display: block;"></td>';
	    $text .= '</tr>';
	    $text .= '<tr>';
	    $text .= '<td colspan="2"><div style="height: 40px;"><p style="font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:normal; font-style:normal; color:#333; padding-bottom: 10px;">Пользователь <a href="/user/view/' .$this->user_id. '">' .Yii::app()->user->getAuthorName($this->user_id). '</a> отправил '.$typeD[$this->type].'</p></div></td>';
	    $text .= '</tr>';
	    $text .= '<tr>';
