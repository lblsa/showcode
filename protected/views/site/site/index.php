    ...
    <div class="new_message">
        ...
        <div class="new_message_descr">
            ...
            <div id="payment" style="border: medium none;box-shadow: 0 0 30px -5px #000000;display: none;height: 522px;left: 50%;margin-left: -408px;margin-top: -267px;padding: 3px;position: fixed;top: 50%;width: 784px; z-index: 65010;">
                <input type="button" value="" onclick="javascript:closeMenu();return false;" id="buy_close" style="width: 17px;border: none; background:url(https://showcode.ru/images/close_button.png) left top no-repeat; display: block; left: 740px; top: 20px; position: absolute; cursor: pointer;" />
                <iframe src="//showcode.ru/events/iframe/9d58b520" width="100%" height="100%" style="border:none;"></iframe>
            </div>                  
