				...
				<tr>
					<td style="background-image:url(http://<?php echo $_SERVER['HTTP_HOST'];?>/images/email/content_bg.png); background-repeat:no-repeat; background-position:left top; padding-top: 0px; padding-right:0; padding-bottom:0; padding-left: 21px;">
						<table cellspacing="0" border="0" cellpadding="0" width="698px" style="margin: 0pt; padding: 0pt; background-color: rgb(255, 255, 255); border-collapse: collapse; border-spacing:0;">
							<tr>
								<td colspan="2">
									<img src="http://<?php echo $_SERVER['HTTP_HOST'];?>/images/email/logo_thank_you.jpg" alt="Showcode. Спасибо за покупку." title="Showcode. Спасибо за покупку." style="margin: 0pt; padding: 0pt; border: 0pt none; display: block;">
								</td>
							</tr>
							<tr>
							<?php if(!$eventUniq):?>
							...
							<?php else: ?>
								<td>
									<table cellspacing="0" border="0" cellpadding="0" width="" style="margin: 0pt; padding: 20px 0; background-color: rgb(255, 255, 255); border-collapse: collapse;">
										<tr>
											<td width="120px">
												<img src="http://<?php echo $_SERVER['HTTP_HOST'];?>/images/email/zoo/zoo-logo.png" alt="<?php echo $event->title;?>" title="<?php echo $event->title;?>" style="margin: 0pt; padding: 0pt; border: 0pt none; display: block; border:1px #cccccc solid;">
											</td>
											<td style="background-color:#30aabc; width:419px">
												<p style="padding:0 10px 0 20px; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; font-style:normal; color:#fff; line-height:18px;">
													<b>Вы купили билет</b> в «<?php echo $event->title;?>»<br />
										...
										<tr>
											...
											<td>
												<img style="vertical-align:top;" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/images/email/zoo/bird_bottom_part.png" alt=""/>
											</td>
										</tr>
									</table>
								</td>
							...
							<?php endif;?>
										...
										<?php if(!$eventUniq):?>
											<td rowspan="3" width="120px">
												<a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/ticket/view/<?php echo $model->uniq;?>" target="_blank" title="">
													<img src="http://<?php echo $_SERVER['HTTP_HOST'].$model->qr;?>" alt="<?php echo $event['title'];?>" style="margin: 0pt; padding: 0pt; border: 0pt none; display: block; border:1px #cccccc solid;">
												</a>
											</td>
										<?php else:?>
											<td rowspan="3" width="120px">
												<a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/ticket/view/<?php echo $model->uniq;?>" target="_blank" title="">
													<img src="http://<?php echo $_SERVER['HTTP_HOST'].$model->qr;?>" alt="<?php echo $event['title'];?>" width="125" style="margin: 0pt; padding: 0pt; border: 0pt none; display: block; border:1px #cccccc solid;">
												</a>
											</td>
										<?php endif;?>
										...
										<tr>
											...
											<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal; font-style:normal; text-decoration:underline; color:#0000ff;">
												<a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST'];?>/ticket/view/<?php echo $model->uniq;?>" title="Здесь вы можете просмотреть статус покупки">
													<?php echo $_SERVER['HTTP_HOST'];?>/ticket/view/<?php echo $model->uniq;?>
												</a>
											</td>
										</tr>
										<tr>
											<td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; font-style:normal; color:#999;">
												Попасть на мероприятие вы сможете:
												<ul style="list-style:none; margin:0pt; padding-top: 3px;padding-right: 0;padding-bottom: 0;padding-left: 0;">
													<li>&mdash; распечастав изображение данного QR-кода на бумаге;</li>
							...
							<tr>
								<td style="padding-top: 10px; border-top-color: #999; border-top-style: solid; border-top-width: 1px;">
									<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal; font-style:normal; color:#333;line-height: 0;">
										С уважением, администрация сайта <a target="_blank" href="<?php echo $_SERVER['HTTP_HOST'];?>" title="">ShowCode.ru</a>.
									</p>
								</td>
								<td style="padding-right: 10px;">&nbsp;</td>
							</tr>
