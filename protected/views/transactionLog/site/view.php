...
echo '</tr>';
	  ...
	  echo '<td>'.CHtml::encode($model->quantity).'</td>';

	  if ($model->type!='free')
	  	echo '<td>'.CHtml::encode($model->total).' руб.</td>';
	  else
	  	echo '<td>0 руб.</td>';

	  if ($ticket->description)
	  	echo '<td>'.CHtml::encode($ticket->description).'</td>';
	  else
	  	echo '<td></td>';

	  if ($ticket->time_begin)
	  	echo '<td>'.CHtml::encode($ticket->time_begin).'</td>';
	  else
	  	echo '<td></td>';

	  if ($ticket->time_end)
	  	echo '<td>'.CHtml::encode($ticket->time_end).'</td>';
	  else
	  	echo '<td></td>';
