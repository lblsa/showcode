...
class MyFunctions extends CApplicationComponent
{
	/**
	 * ���������� �� ����� ����� ������� ��������� ��� ����������� �����.
	 * @return string 'mobile' ��� 'site'.
	 */
	public function siteType()
	{
		if (Yii::app()->session['siteType']=='mobile')
			return 'mobile';
		else
			return 'site';
	}
	 ...
	 * @return string ���� ������� MySQL.
	 */
	public function dateForMysql($datetime)
	{
	 ...
	 */
	public function mail_html($to_addr,$from_addr,$from_name,$message,$title)
	{
		$eol="\n"; // unix only
		...
		$returnPath = '-fnoreply@'.$_SERVER['HTTP_HOST'];
	 ...
	 * @return integer Если 0 - браузер стационарный или определить его не удалось. 1-4 - браузер запущен на мобильном устройстве.
	 */
