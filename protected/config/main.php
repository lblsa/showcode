...
return array(
	...
	'params'=>array(
		...
		'isWeb'=>'1',							//еЯКХ isWeb==0, РН ОПХКНФЕМХЕ РЕЯРХПСЕРЯЪ МЮ КНЙЮКЭМНИ ЛЮЬХМЕ.
		'qiwiLogin'=>'16029',
		'qiwiPass'=>'Dfm3rnn7snnbbd?as',
		'vk_id'=>'2647518',						//ID API йНМРЮЙРЮ
		'vk_code'=>'PiWbuy2FQaYwkhItsI32',		//ЯЕЙПЕРМШИ ЙКЧВ ДКЪ API ЙНМРЮЙРЮ
		'face_id'=>'275201229183713',			//ID APP Facebook
		'face_code'=>'84e772b9e26cf9281d3aad8576782cd2',		//ЯЕЙПЕРМШИ ЙКЧВ ДКЪ API Facebook
		'access_token'=>'275201229183713|uEhhNWS_ehHCWdrJ6tWidr55xXk',	// Access_token ДКЪ ДНЯРСОЮ Й API graph.facebook.com
		//оНКСВЕМХЕ: $access_token = file_get_contents('https://graph.facebook.com/oauth/access_token?client_id=' .Yii::app()->params['face_id']. '&client_secret=' .Yii::app()->params['face_code']. '&grant_type=client_credentials');
	...
	'components'=>array(
		...
		// оНДЙКЧВЕМХЕ ЛНХУ ТСМЙЖХИ ДКЪ ХЯОНКЭГНБЮМХЪ.
		'mf'=>array(
			'class'=>'MyFunctions',
		),
