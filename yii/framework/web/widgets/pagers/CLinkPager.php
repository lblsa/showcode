...
{
	const CSS_FIRST_PAGE='page first';
	const CSS_LAST_PAGE='page last';
	const CSS_PREVIOUS_PAGE='page previous';
	const CSS_NEXT_PAGE='page next';
	const CSS_INTERNAL_PAGE='page pag_com_events_number_link';
