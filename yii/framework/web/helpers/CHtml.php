...
class CHtml
{
	 ...
	 * @see clientChange
	 */
	public static $liveEvents = false;
...
EOD;
	...
	protected static function clientChange($event,&$htmlOptions)
	{
		...
		if($live)
			$cs->registerScript('Yii.CHtml.#' . $id, "$('body').live('$event','#$id',function(){{$handler}});");
		else
			$cs->registerScript('Yii.CHtml.#' . $id, "$('#$id').live('$event', function(){{$handler}});");
